      ...
      <div className="container mx-auto my-12 p-12 bg-gray-100">
        <div className="mb-4 w-full md:w-1/4 border-t-4 border-red-400 rounded-b-lg rounded-t shadow-lg bg-white overflow-hidden">
          <div className="mt-4 mb-8 px-6 py-4">
            <div className="py-4 text-lg text-gray-700 tracking-wide">
              一级菜单
            </div>
        ...
        <div className="mb-4 w-full md:w-1/4 shadow">
          <ul className="list-reset">
            <li>
              <a
                href=""
                className="block p-4 border-r-4 border-purple-400 text-base text-gray-gray-400 font-bold hover:border-purple-500 hover:bg-purple-100"
              >
                商品管理
              </a>
            </li>
            <li>
              <a
                href=""
                className="block p-4 border-r-4 border-transparent text-base text-gray-gray-400 font-bold hover:border-purple-500 hover:bg-purple-100"
              >
                系统管理
              </a>
            </li>
