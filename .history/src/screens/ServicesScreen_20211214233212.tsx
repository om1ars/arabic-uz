        ...
        <div className="container mx-auto px-4">
          ...
          <div className="pricing-plans lg:flex lg:-mx-4 mt-6 md:mt-12">
            <div className="pricing-plan-wrap lg:w-1/3 my-4 md:my-6">
              <div className="pricing-plan border-t-4 border-solid border-white bg-white text-center max-w-sm mx-auto hover:green-indigo-600 transition-colors duration-300">
