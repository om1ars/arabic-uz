    ...
    <>
      {sidebarOptions.map((v, i) => (
        <div className="relative min-h-screen md:flex">
          ...
          <div className=" bg-green-800 text-green-100 w-64 space-y-6 py-7 px-2 absolute inset-y-0 left-0 transform -translate-x-full md:relative md:translate-x-0 transition duration-200 ease-in-out">
