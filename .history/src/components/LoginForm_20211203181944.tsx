  ...
  <div className="mx-auto max-w-md px-6 py-12 bg-white border-0 shadow-lg sm:rounded-3xl">
    ...
    <form id="form" >
      ...
      <fieldset className="relative z-0 w-full p-px mb-5">
        <legend className="absolute text-gray-500 transhtmlForm scale-75 -top-3 origin-0">Choose an option</legend>
      ...
      <button
        id="button"
        type="button"
        className="w-full px-6 py-3 mt-3 text-lg text-white transition-all duration-150 ease-linear rounded-lg shadow outline-none bg-green-500 hover:bg-green-500 hover:shadow-lg focus:outline-none"
      >
        Toggle Error
      </button>
    </form>
