...
import { fetchTest } from "./dataLayer/slices/fetchTest";
import { selectStatus } from "./dataLayer/slices/testSlice";
import { useTypedSelector } from "./dataLayer/store";

export default function LoginhtmlForm() {
  const dispatch = useDispatch();
  useEffect(() => {
    const handleClick = dispatch(fetchTest(1));
  }, []);
