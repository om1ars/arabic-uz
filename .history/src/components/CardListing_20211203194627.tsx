...
export default function CardListing() {
  ...
  const randomNumberOfColor = randomColorNumbers[Math.floor(Math.random() * randomColorNumbers.length)]
    ...
    >
      ...
      <div className="bg-white p-10 rounded-lg shadow-md">
        ...
        <div className="mt-4 mb-10">
          ...
          <div className="bg-gray-400 w-64 h-3 rounded-lg mt-2 overflow-hidden">
            <div
              className={`bg-${randomColor[colors[Math:M.floor(Math.random() * colors.length)]]}-${randomNumberOfColor} w-3/4 h-full rounded-lg shadow-md`}
            ></div>
          </div>
        </div>
        <h3 className="text-xs uppercase">Current lesson:</h3>
